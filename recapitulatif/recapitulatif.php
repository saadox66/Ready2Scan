                ...
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<div class='col'>";
                            // Utilisation de l'icône Bootstrap pour le sujet
                            echo "<h2 style='margin:20px'><i class='bi bi-journal' fs-1></i><span> " . $row["sjt_intitule"] . "</span></h2>";

                            // Requête pour récupérer les fiches associées à ce sujet
                            $sql_fiches = "SELECT * FROM t_fiche_fic WHERE sjt_num ='" . $row['sjt_num'] . "' AND fic_etat = 'O';";
                        ...
                        if ($result_fiches->num_rows > 0) {
                            ...
                            while($row_fiche = $result_fiches->fetch_assoc()) {
                                ...
                                echo "<div class='img rounded d-flex align-items-end' style='background-image: url(../images/" .  $row_fiche['fic_pathImage'] . ");'>";
                                echo "</div>";
                                echo "<div class='text'>";
                                echo "<h2 class='mb-0'><a href='./fiche.php?code=" . $row_fiche['fic_code']."'>" . $row_fiche['fic_label'] . "</a></h2>";
                            ...
                            echo "<p>Aucune fiche associée à ce sujet.</p>";
                        }

                        echo "</div>";
                        echo "</div>"; // Fin de la ligne des sujets
                    }
                } else {
