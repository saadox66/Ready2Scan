...
<section class="text-center" style="margin-bottom : 60px;">
  <!-- Background image -->
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-lg-8">
          ...
          <form action="session_action.php" method="post">
            ...
            <!-- Email input -->
            <div class="form-outline mb-4 text-" style="text-align: start;">
                <label class="form-label" for="email">Email address</label>
                <input type="email" id="email" class="form-control" placeholder="example@exmp.ex" name="email"/>
            </div>

            <!-- Password input -->
            <div class="form-outline mb-4" style="text-align: start;">
                <label class="form-label" for="password">Password</label>
                <input type="password" id="password" class="form-control" placeholder="*********" name="password"/>
            </div>

            <!-- Submit button -->
            <button type="submit" class="btn btn-primary btn-block mb-4" id="login_btn">
              Log in
            </button>
